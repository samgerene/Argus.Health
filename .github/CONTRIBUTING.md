...
1. Configure the upstream repo (`git remote add upstream git://github.com/samgerene/Argus.Health`) 
...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical Argus.Health version) may be updated. If this happens you should:
...
1. Wait for @samgerene to merge your changes in.

And remember; **A pull-request with tests is a pull-request that's likely to be pulled in.** :grin: Bonus points if you document your feature in our [wiki](https://github.com/samgerene/Argus.Health/wiki) once it has been pulled in

## Style Guidelines

- Indent with 4 spaces, **not** tabs.
- No underscore (`_`) prefix for member names.
- Use `this` when accessing instance members, e.g. `this.Name = "Argus.Health";`.
